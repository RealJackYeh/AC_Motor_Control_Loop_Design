...
Go_with_delay_newPI = pi_controlller_new*delay_computation*delay_output*d_axis_plant;
Gc_with_delay_newPI = Go_with_delay_newPI/(1+Go_with_delay_newPI*tf_filter*delay_SH);
h=bodeoptions;
h.PhaseMatching='on';
h.Title.FontSize = 14;
...
bodeplot(Gc_no_delay,'-b',Gc_with_delay,'-.r',Gc_with_delay_newPI,'--g',{1,10000},h);
legend('NoDelay','WithDelay','WithDelay_newPI');
